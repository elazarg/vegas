...
the boundary between public and private fields.  And it
\emph{provides several lenses} on the resulting program: an
executable contract on chain, an extensive-form game for
equilibrium analysis, an SMT-LIB encoding for reachability
...
Vegas is deliberately narrow.  The aim is to make the round
trip from specification to deployed contract to game-theoretic
analysis short and reliable for a useful class of protocols,
not to be a general-purpose smart-contract language.
Concretely, in scope are:

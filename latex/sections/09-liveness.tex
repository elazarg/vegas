...
be bailed.  A per-action deadline scheme would tighten the
window further at the cost of substantially more state; the
single-window design is the simpler starting point.

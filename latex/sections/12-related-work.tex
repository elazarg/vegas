...
Vegas's randomness story is therefore narrow by intent: a
finite-domain, hard-conditioning fragment of the PPL design
space, slotted into a domain-specific language whose primary
contribution is elsewhere (the EventGraph IR, the multi-backend
agreement, the automatic commit-reveal pass).  We borrow the
view of conditioning as data, but not the inference machinery.

...
The one thing the tool is designed for is shortening the loop
between ``the protocol I want to play'' and ``the contract that
will play it'' --- short, mechanical, auditable.  The example library exercises this with thirty-nine
...
small enough to describe completely: a finite-graph IR,

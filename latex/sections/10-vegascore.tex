...
\item The various backends agree with Vegas's IR by construction:
  every backend reads the same EventGraph and lowers it
  systematically.  This is closer to a code-review property
  than to a formal one --- there is no compiler proof.
...
The honest summary: Vegas can be used today as a productive tool

...
public class VegasParser extends Parser {
	...
	public static final int
		...
		ROLE_ID=53, LOWER_ID=54, INT=55, ADDRESS=56, STRING=57, BlockComment=58, 
		LineComment=59, WS=60;
	public static final int
		...
		RULE_outcome = 12, RULE_item = 13, RULE_exp = 14, RULE_varDec = 15, RULE_distExp = 16, 
		RULE_distVal = 17, RULE_weightedItem = 18, RULE_typeId = 19, RULE_varId = 20, 
		RULE_roleId = 21;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "gameDec", "gameId", "typeDec", "macroDec", "paramDec", "typeExp", 
			"ext", "query", "randomQuery", "queryHandler", "groupHandler", "outcome", 
			"item", "exp", "varDec", "distExp", "distVal", "weightedItem", "typeId", 
			"varId", "roleId"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'or'", "'random'", "'sample'", "'withdraw'", "'$'", "'where'", "'||'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, "ROLE_ID", "LOWER_ID", "INT", "ADDRESS", 
	...
	private ExpContext exp(int _p) throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 136093164124504068L) != 0)) {
					{
					setState(270);
	...
	public final DistExpContext distExp() throws RecognitionException {
		...
		enterRule(_localctx, 32, RULE_distExp);
		int _la;
		try {
			setState(357);
			_errHandler.sync(this);
	...
	public final DistValContext distVal() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_distVal);
		int _la;
		try {
			setState(361);
			_errHandler.sync(this);
	...
	public final WeightedItemContext weightedItem() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_weightedItem);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(363);
	...
	public final RoleIdContext roleId() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_roleId);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(371);
	...
	public static final String _serializedATN =
		...
		"\u0003\u000b\u00da\b\u000b\u0001\f\u0001\f\u0001\f\u0001\f\u0001\f\u0001"+
		"\f\u0001\f\u0001\f\u0001\f\u0001\f\u0001\f\u0001\f\u0001\f\u0001\f\u0001"+
		"\f\u0001\f\u0001\f\u0001\f\u0001\f\u0004\f\u00ef\b\f\u000b\f\f\f\u00f0"+
		"\u0001\f\u0001\f\u0003\f\u00f5\b\f\u0001\r\u0001\r\u0001\r\u0001\r\u0003"+
		"\r\u00fb\b\r\u0001\r\u0001\r\u0001\r\u0003\r\u0100\b\r\u0003\r\u0102\b"+
		"\r\u0001\u000e\u0001\u000e\u0001\u000e\u0001\u000e\u0001\u000e\u0001\u000e"+
		"\u0001\u000e\u0001\u000e\u0001\u000e\u0001\u000e\u0001\u000e\u0001\u000e"+
		"\u0001\u000e\u0001\u000e\u0005\u000e\u0112\b\u000e\n\u000e\f\u000e\u0115"+
		"\t\u000e\u0003\u000e\u0117\b\u000e\u0001\u000e\u0001\u000e\u0001\u000e"+

...
contract MontyHall {
    ...
    function withdraw_Host() public by(Role.Host) action(Role.Host, 7) depends(Role.Host, 6) {
        ...
        claimed_Host = true;
        int256 payout = ((!done_Host_car) ? (done_Host_car ? (20 + (((done_Host_car ? 0 : 20) + (true ? 0 : 20)) / ((((done_Host_car ? 1 : 0) + (true ? 1 : 0)) > 0) ? ((done_Host_car ? 1 : 0) + (true ? 1 : 0)) : 1))) : 0) : ((!done_Guest_d) ? (done_Host_car ? (20 + (((done_Host_car ? 0 : 20) + (done_Guest_d ? 0 : 20)) / ((((done_Host_car ? 1 : 0) + (done_Guest_d ? 1 : 0)) > 0) ? ((done_Host_car ? 1 : 0) + (done_Guest_d ? 1 : 0)) : 1))) : 0) : ((!done_Host_goat) ? ((done_Host_car && done_Host_goat) ? (20 + ((((done_Host_car && done_Host_goat) ? 0 : 20) + (done_Guest_d ? 0 : 20)) / (((((done_Host_car && done_Host_goat) ? 1 : 0) + (done_Guest_d ? 1 : 0)) > 0) ? (((done_Host_car && done_Host_goat) ? 1 : 0) + (done_Guest_d ? 1 : 0)) : 1))) : 0) : ((!done_Guest_switch) ? ((done_Host_car && done_Host_goat) ? (20 + ((((done_Host_car && done_Host_goat) ? 0 : 20) + ((done_Guest_d && done_Guest_switch) ? 0 : 20)) / (((((done_Host_car && done_Host_goat) ? 1 : 0) + ((done_Guest_d && done_Guest_switch) ? 1 : 0)) > 0) ? (((done_Host_car && done_Host_goat) ? 1 : 0) + ((done_Guest_d && done_Guest_switch) ? 1 : 0)) : 1))) : 0) : (((Guest_d != Host_car) == Guest_switch) ? 0 : 40)))));
        if (payout > 0) {
    ...
    function withdraw_Guest() public by(Role.Guest) action(Role.Guest, 6) depends(Role.Host, 6) {
        ...
        claimed_Guest = true;
        int256 payout = ((!done_Host_car) ? (true ? (20 + (((done_Host_car ? 0 : 20) + (true ? 0 : 20)) / ((((done_Host_car ? 1 : 0) + (true ? 1 : 0)) > 0) ? ((done_Host_car ? 1 : 0) + (true ? 1 : 0)) : 1))) : 0) : ((!done_Guest_d) ? (done_Guest_d ? (20 + (((done_Host_car ? 0 : 20) + (done_Guest_d ? 0 : 20)) / ((((done_Host_car ? 1 : 0) + (done_Guest_d ? 1 : 0)) > 0) ? ((done_Host_car ? 1 : 0) + (done_Guest_d ? 1 : 0)) : 1))) : 0) : ((!done_Host_goat) ? (done_Guest_d ? (20 + ((((done_Host_car && done_Host_goat) ? 0 : 20) + (done_Guest_d ? 0 : 20)) / (((((done_Host_car && done_Host_goat) ? 1 : 0) + (done_Guest_d ? 1 : 0)) > 0) ? (((done_Host_car && done_Host_goat) ? 1 : 0) + (done_Guest_d ? 1 : 0)) : 1))) : 0) : ((!done_Guest_switch) ? ((done_Guest_d && done_Guest_switch) ? (20 + ((((done_Host_car && done_Host_goat) ? 0 : 20) + ((done_Guest_d && done_Guest_switch) ? 0 : 20)) / (((((done_Host_car && done_Host_goat) ? 1 : 0) + ((done_Guest_d && done_Guest_switch) ? 1 : 0)) > 0) ? (((done_Host_car && done_Host_goat) ? 1 : 0) + ((done_Guest_d && done_Guest_switch) ? 1 : 0)) : 1))) : 0) : (((Guest_d != Host_car) == Guest_switch) ? 40 : 0)))));
        if (payout > 0) {

...
contract VickreyAuction {
    ...
    function withdraw_B2() public by(Role.B2) action(Role.B2, 6) depends(Role.B3, 6) {
    ...
    function withdraw_B3() public by(Role.B3) action(Role.B3, 7) depends(Role.B3, 6) {
    ...
    function withdraw_Seller() public by(Role.Seller) action(Role.Seller, 1) depends(Role.B3, 6) {
    ...
    function withdraw_B1() public by(Role.B1) action(Role.B1, 5) depends(Role.B3, 6) {

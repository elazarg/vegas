...
def withdraw_Bob():
    ...
    payout: int256 = (-10) if ((not self.done_Alice_c) or (not self.done_Bob_c)) else (-10) if (not self.done_Issuer_c) else (-10) if (self.Alice_c == self.Bob_c) else (-10) if (((((self.Alice_c + self.Bob_c) + self.Issuer_c) / 2) * 2) == ((self.Alice_c + self.Bob_c) + self.Issuer_c)) else 20
    if payout > 0:
...
def withdraw_Issuer():
    ...
    payout: int256 = 20 if ((not self.done_Alice_c) or (not self.done_Bob_c)) else (-10) if (not self.done_Issuer_c) else 20 if (self.Alice_c == self.Bob_c) else (-10) if (((((self.Alice_c + self.Bob_c) + self.Issuer_c) / 2) * 2) == ((self.Alice_c + self.Bob_c) + self.Issuer_c)) else (-10)
    if payout > 0:
...
def withdraw_Alice():
    ...
    payout: int256 = (-10) if ((not self.done_Alice_c) or (not self.done_Bob_c)) else 20 if (not self.done_Issuer_c) else (-10) if (self.Alice_c == self.Bob_c) else 20 if (((((self.Alice_c + self.Bob_c) + self.Issuer_c) / 2) * 2) == ((self.Alice_c + self.Bob_c) + self.Issuer_c)) else (-10)
    if payout > 0:

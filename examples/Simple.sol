...
contract Simple {
    ...
    function withdraw_A() public by(Role.A) action(Role.A, 5) depends(Role.A, 4) {
        ...
        claimed_A = true;
        int256 payout = ((!done_A_c) ? (done_A_c ? (6 + (((done_A_c ? 0 : 6) + (true ? 0 : 6)) / ((((done_A_c ? 1 : 0) + (true ? 1 : 0)) > 0) ? ((done_A_c ? 1 : 0) + (true ? 1 : 0)) : 1))) : 0) : ((!done_B_c) ? (done_A_c ? (6 + (((done_A_c ? 0 : 6) + (done_B_c ? 0 : 6)) / ((((done_A_c ? 1 : 0) + (done_B_c ? 1 : 0)) > 0) ? ((done_A_c ? 1 : 0) + (done_B_c ? 1 : 0)) : 1))) : 0) : ((A_c != B_c) ? 9 : 3)));
        if (payout > 0) {
    ...
    function withdraw_B() public by(Role.B) action(Role.B, 4) depends(Role.A, 4) {
        require((!claimed_B), "already claimed");
        claimed_B = true;
        int256 payout = ((!done_A_c) ? (true ? (6 + (((done_A_c ? 0 : 6) + (true ? 0 : 6)) / ((((done_A_c ? 1 : 0) + (true ? 1 : 0)) > 0) ? ((done_A_c ? 1 : 0) + (true ? 1 : 0)) : 1))) : 0) : ((!done_B_c) ? (done_B_c ? (6 + (((done_A_c ? 0 : 6) + (done_B_c ? 0 : 6)) / ((((done_A_c ? 1 : 0) + (done_B_c ? 1 : 0)) > 0) ? ((done_A_c ? 1 : 0) + (done_B_c ? 1 : 0)) : 1))) : 0) : ((A_c == B_c) ? 9 : 3)));
        if (payout > 0) {

...
(define-public (timeout)
    (begin
        ...
        (if (not (is-done u0)) (begin (map-set claims (unwrap-panic (var-get role-guest)) u40) (var-set payoffs-distributed true) (ok true)) (err ERR_NOT_OPEN))
    )
)

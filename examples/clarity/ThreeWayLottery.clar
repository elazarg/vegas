...
(define-public (finalize)
    (begin
        ...
        (asserts! (is-done u8) ERR_NOT_OPEN)
        (asserts! (<= (+ (+ (to-uint (if (and (and (or (is-done u5) (is-done u6)) (or (is-done u7) (is-done u8))) (or (is-done u3) (is-done u4))) (if (is-eq (mod (+ (+ (var-get var-issuer-c) (var-get var-alice-c)) (var-get var-bob-c)) 3) 0) 6 (if (is-eq (mod (+ (+ (var-get var-issuer-c) (var-get var-alice-c)) (var-get var-bob-c)) 3) 1) 24 6)) (if (and (not (or (is-done u5) (is-done u6))) (not (or (is-done u7) (is-done u8)))) 1 (if (and (not (or (is-done u5) (is-done u6))) (not (or (is-done u3) (is-done u4)))) 34 (if (and (not (or (is-done u7) (is-done u8))) (not (or (is-done u3) (is-done u4)))) 1 (if (not (or (is-done u5) (is-done u6))) 17 (if (not (or (is-done u7) (is-done u8))) 2 (if (not (or (is-done u3) (is-done u4))) 17 12)))))))) (to-uint (if (and (and (or (is-done u5) (is-done u6)) (or (is-done u7) (is-done u8))) (or (is-done u3) (is-done u4))) (if (is-eq (mod (+ (+ (var-get var-issuer-c) (var-get var-alice-c)) (var-get var-bob-c)) 3) 0) 6 (if (is-eq (mod (+ (+ (var-get var-issuer-c) (var-get var-alice-c)) (var-get var-bob-c)) 3) 1) 6 24)) (if (and (not (or (is-done u5) (is-done u6))) (not (or (is-done u7) (is-done u8)))) 34 (if (and (not (or (is-done u5) (is-done u6))) (not (or (is-done u3) (is-done u4)))) 1 (if (and (not (or (is-done u7) (is-done u8))) (not (or (is-done u3) (is-done u4)))) 1 (if (not (or (is-done u5) (is-done u6))) 17 (if (not (or (is-done u7) (is-done u8))) 17 (if (not (or (is-done u3) (is-done u4))) 2 12))))))))) (to-uint (if (and (and (or (is-done u5) (is-done u6)) (or (is-done u7) (is-done u8))) (or (is-done u3) (is-done u4))) (if (is-eq (mod (+ (+ (var-get var-issuer-c) (var-get var-alice-c)) (var-get var-bob-c)) 3) 0) 24 (if (is-eq (mod (+ (+ (var-get var-issuer-c) (var-get var-alice-c)) (var-get var-bob-c)) 3) 1) 6 6)) (if (and (not (or (is-done u5) (is-done u6))) (not (or (is-done u7) (is-done u8)))) 1 (if (and (not (or (is-done u5) (is-done u6))) (not (or (is-done u3) (is-done u4)))) 1 (if (and (not (or (is-done u7) (is-done u8))) (not (or (is-done u3) (is-done u4)))) 34 (if (not (or (is-done u5) (is-done u6))) 2 (if (not (or (is-done u7) (is-done u8))) 17 (if (not (or (is-done u3) (is-done u4))) 17 12))))))))) (var-get total-pot)) ERR_PAYOUT_TOO_HIGH)
        (map-set claims (unwrap-panic (var-get role-bob)) (to-uint (if (and (and (or (is-done u5) (is-done u6)) (or (is-done u7) (is-done u8))) (or (is-done u3) (is-done u4))) (if (is-eq (mod (+ (+ (var-get var-issuer-c) (var-get var-alice-c)) (var-get var-bob-c)) 3) 0) 6 (if (is-eq (mod (+ (+ (var-get var-issuer-c) (var-get var-alice-c)) (var-get var-bob-c)) 3) 1) 24 6)) (if (and (not (or (is-done u5) (is-done u6))) (not (or (is-done u7) (is-done u8)))) 1 (if (and (not (or (is-done u5) (is-done u6))) (not (or (is-done u3) (is-done u4)))) 34 (if (and (not (or (is-done u7) (is-done u8))) (not (or (is-done u3) (is-done u4)))) 1 (if (not (or (is-done u5) (is-done u6))) 17 (if (not (or (is-done u7) (is-done u8))) 2 (if (not (or (is-done u3) (is-done u4))) 17 12)))))))))
        (map-set claims (unwrap-panic (var-get role-issuer)) (to-uint (if (and (and (or (is-done u5) (is-done u6)) (or (is-done u7) (is-done u8))) (or (is-done u3) (is-done u4))) (if (is-eq (mod (+ (+ (var-get var-issuer-c) (var-get var-alice-c)) (var-get var-bob-c)) 3) 0) 6 (if (is-eq (mod (+ (+ (var-get var-issuer-c) (var-get var-alice-c)) (var-get var-bob-c)) 3) 1) 6 24)) (if (and (not (or (is-done u5) (is-done u6))) (not (or (is-done u7) (is-done u8)))) 34 (if (and (not (or (is-done u5) (is-done u6))) (not (or (is-done u3) (is-done u4)))) 1 (if (and (not (or (is-done u7) (is-done u8))) (not (or (is-done u3) (is-done u4)))) 1 (if (not (or (is-done u5) (is-done u6))) 17 (if (not (or (is-done u7) (is-done u8))) 17 (if (not (or (is-done u3) (is-done u4))) 2 12)))))))))
        (map-set claims (unwrap-panic (var-get role-alice)) (to-uint (if (and (and (or (is-done u5) (is-done u6)) (or (is-done u7) (is-done u8))) (or (is-done u3) (is-done u4))) (if (is-eq (mod (+ (+ (var-get var-issuer-c) (var-get var-alice-c)) (var-get var-bob-c)) 3) 0) 24 (if (is-eq (mod (+ (+ (var-get var-issuer-c) (var-get var-alice-c)) (var-get var-bob-c)) 3) 1) 6 6)) (if (and (not (or (is-done u5) (is-done u6))) (not (or (is-done u7) (is-done u8)))) 1 (if (and (not (or (is-done u5) (is-done u6))) (not (or (is-done u3) (is-done u4)))) 1 (if (and (not (or (is-done u7) (is-done u8))) (not (or (is-done u3) (is-done u4)))) 34 (if (not (or (is-done u5) (is-done u6))) 2 (if (not (or (is-done u7) (is-done u8))) 17 (if (not (or (is-done u3) (is-done u4))) 17 12)))))))))
...
(define-public (timeout)
    (begin
        ...
        (if (not (is-done u0)) (begin (map-set claims (unwrap-panic (var-get role-alice)) u1) (map-set claims (unwrap-panic (var-get role-bob)) u1) (map-set claims (unwrap-panic (var-get role-issuer)) u34) (var-set payoffs-distributed true) (ok true)) (err ERR_NOT_OPEN))
    )
)

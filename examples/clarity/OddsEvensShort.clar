...
(define-public (cancel-uninitialized)
    (begin
        ...
        (match (var-get role-even) r
            (let ((amt (var-get deposit-even)))
                (if (> amt u0)
        ...
        (match (var-get role-odd) r
            (let ((amt (var-get deposit-odd)))
                (if (> amt u0)
                    (unwrap-panic (as-contract? ((with-stx amt)) (unwrap-panic (stx-transfer? amt tx-sender r))))
                    true
                )
        ...
        (var-set role-even none)
        (var-set deposit-even u0)
        (var-set role-odd none)
        (var-set deposit-odd u0)
...
(define-public (finalize)
    (begin
        ...
        (asserts! (is-done u3) ERR_NOT_OPEN)
        (asserts! (is-eq (+ (unwrap-panic (to-uint (if (and (or (is-done u1) (is-done u3)) (or (is-done u0) (is-done u2))) (if (is-eq (var-get var-even-c) (var-get var-odd-c)) 126 74) (if (and (not (or (is-done u1) (is-done u3))) (or (is-done u0) (is-done u2))) 20 (if (and (or (is-done u1) (is-done u3)) (not (or (is-done u0) (is-done u2)))) 180 100))))) (unwrap-panic (to-uint (if (and (or (is-done u1) (is-done u3)) (or (is-done u0) (is-done u2))) (if (is-eq (var-get var-even-c) (var-get var-odd-c)) 74 126) (if (and (not (or (is-done u1) (is-done u3))) (or (is-done u0) (is-done u2))) 180 (if (and (or (is-done u1) (is-done u3)) (not (or (is-done u0) (is-done u2)))) 20 100)))))) (var-get total-pot)) ERR_PAYOUT_TOO_HIGH)
        (map-set claims (unwrap-panic (var-get role-even)) (unwrap-panic (to-uint (if (and (or (is-done u1) (is-done u3)) (or (is-done u0) (is-done u2))) (if (is-eq (var-get var-even-c) (var-get var-odd-c)) 126 74) (if (and (not (or (is-done u1) (is-done u3))) (or (is-done u0) (is-done u2))) 20 (if (and (or (is-done u1) (is-done u3)) (not (or (is-done u0) (is-done u2)))) 180 100))))))
        (map-set claims (unwrap-panic (var-get role-odd)) (unwrap-panic (to-uint (if (and (or (is-done u1) (is-done u3)) (or (is-done u0) (is-done u2))) (if (is-eq (var-get var-even-c) (var-get var-odd-c)) 74 126) (if (and (not (or (is-done u1) (is-done u3))) (or (is-done u0) (is-done u2))) 180 (if (and (or (is-done u1) (is-done u3)) (not (or (is-done u0) (is-done u2)))) 20 100))))))
...
(define-public (timeout)
    (begin
        ...
        (if (not (is-done u0)) (begin (map-set claims (unwrap-panic (var-get role-even)) u200) (var-set payoffs-distributed true) (ok true)) (if (not (is-done u1)) (begin (map-set claims (unwrap-panic (var-get role-odd)) u200) (var-set payoffs-distributed true) (ok true)) (if (not (is-done u2)) (begin (map-set claims (unwrap-panic (var-get role-even)) u200) (var-set payoffs-distributed true) (ok true)) (if (not (is-done u3)) (begin (map-set claims (unwrap-panic (var-get role-odd)) u200) (var-set payoffs-distributed true) (ok true)) (err ERR_NOT_OPEN)))))
    )
)

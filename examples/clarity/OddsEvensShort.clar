...
(define-public (finalize)
    (begin
        ...
        (asserts! (and (is-done u2) (is-done u0) (is-done u3) (is-done u1)) ERR_NOT_OPEN)
        (map-set claims (unwrap-panic (var-get role-even)) (if (and (or (is-done u2) (is-done u3)) (or (is-done u0) (is-done u1))) (if (is-eq (var-get var-even-c) (var-get var-odd-c)) 126 74) (if (and (not (or (is-done u2) (is-done u3))) (or (is-done u0) (is-done u1))) 20 (if (and (or (is-done u2) (is-done u3)) (not (or (is-done u0) (is-done u1)))) 180 100))))
        (map-set claims (unwrap-panic (var-get role-odd)) (if (and (or (is-done u2) (is-done u3)) (or (is-done u0) (is-done u1))) (if (is-eq (var-get var-even-c) (var-get var-odd-c)) 74 126) (if (and (not (or (is-done u2) (is-done u3))) (or (is-done u0) (is-done u1))) 180 (if (and (or (is-done u2) (is-done u3)) (not (or (is-done u0) (is-done u1)))) 20 100))))
...
(define-public (timeout)
    (begin
        ...
        (if (and (is-done u2) (is-done u0) (is-done u3) (not (is-done u1))) (begin (map-set claims (unwrap-panic (var-get role-even)) u180) (map-set claims (unwrap-panic (var-get role-odd)) u20) (var-set payoffs-distributed true) (ok true)) (if (and (is-done u2) (is-done u0) (is-done u1) (not (is-done u3))) (begin (map-set claims (unwrap-panic (var-get role-even)) u20) (map-set claims (unwrap-panic (var-get role-odd)) u180) (var-set payoffs-distributed true) (ok true)) (if (and (is-done u2) (is-done u0) (not (is-done u3)) (not (is-done u1))) (begin (map-set claims (unwrap-panic (var-get role-even)) u100) (map-set claims (unwrap-panic (var-get role-odd)) u100) (var-set payoffs-distributed true) (ok true)) (if (and (is-done u2) (not (is-done u0))) (begin (map-set claims (unwrap-panic (var-get role-even)) u100) (map-set claims (unwrap-panic (var-get role-odd)) u100) (var-set payoffs-distributed true) (ok true)) (if (and (is-done u0) (not (is-done u2))) (begin (map-set claims (unwrap-panic (var-get role-even)) u100) (map-set claims (unwrap-panic (var-get role-odd)) u100) (var-set payoffs-distributed true) (ok true)) (if (and (not (is-done u2)) (not (is-done u0))) (begin (map-set claims (unwrap-panic (var-get role-even)) u100) (map-set claims (unwrap-panic (var-get role-odd)) u100) (var-set payoffs-distributed true) (ok true)) (err ERR_NOT_OPEN)))))))
    )
)

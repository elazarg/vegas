...
(define-public (timeout)
    (begin
        ...
        (if (and (is-done u2) (is-done u0) (is-done u3) (is-done u1)) (begin (map-set claims (unwrap-panic (var-get role-even)) u126) (map-set claims (unwrap-panic (var-get role-odd)) u74) (var-set payoffs-distributed true) (ok true)) (if (and (is-done u2) (is-done u0) (is-done u3) (not (is-done u1))) (begin (map-set claims (unwrap-panic (var-get role-even)) u180) (map-set claims (unwrap-panic (var-get role-odd)) u20) (var-set payoffs-distributed true) (ok true)) (if (and (is-done u2) (is-done u0) (is-done u1) (not (is-done u3))) (begin (map-set claims (unwrap-panic (var-get role-even)) u20) (map-set claims (unwrap-panic (var-get role-odd)) u180) (var-set payoffs-distributed true) (ok true)) (if (and (is-done u2) (is-done u0) (not (is-done u3)) (not (is-done u1))) (begin (map-set claims (unwrap-panic (var-get role-even)) u100) (map-set claims (unwrap-panic (var-get role-odd)) u100) (var-set payoffs-distributed true) (ok true)) (if (and (is-done u2) (not (is-done u0))) (begin (map-set claims (unwrap-panic (var-get role-even)) u100) (map-set claims (unwrap-panic (var-get role-odd)) u100) (var-set payoffs-distributed true) (ok true)) (if (and (is-done u0) (not (is-done u2))) (begin (map-set claims (unwrap-panic (var-get role-even)) u100) (map-set claims (unwrap-panic (var-get role-odd)) u100) (var-set payoffs-distributed true) (ok true)) (if (and (not (is-done u2)) (not (is-done u0))) (begin (map-set claims (unwrap-panic (var-get role-even)) u100) (map-set claims (unwrap-panic (var-get role-odd)) u100) (var-set payoffs-distributed true) (ok true)) (err ERR_NOT_OPEN))))))))
    )
)

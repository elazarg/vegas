...
(define-public (finalize)
    (begin
        ...
        (asserts! (<= (+ (to-uint (if (and (or (is-done u4) (is-done u5)) (or (is-done u2) (is-done u3))) (if (is-eq (var-get var-even-c) (var-get var-odd-c)) 126 74) (if (and (not (or (is-done u4) (is-done u5))) (or (is-done u2) (is-done u3))) 20 (if (and (or (is-done u4) (is-done u5)) (not (or (is-done u2) (is-done u3)))) 180 100)))) (to-uint (if (and (or (is-done u4) (is-done u5)) (or (is-done u2) (is-done u3))) (if (is-eq (var-get var-even-c) (var-get var-odd-c)) 74 126) (if (and (not (or (is-done u4) (is-done u5))) (or (is-done u2) (is-done u3))) 180 (if (and (or (is-done u4) (is-done u5)) (not (or (is-done u2) (is-done u3)))) 20 100))))) (var-get total-pot)) ERR_PAYOUT_TOO_HIGH)
        (map-set claims (unwrap-panic (var-get role-even)) (to-uint (if (and (or (is-done u4) (is-done u5)) (or (is-done u2) (is-done u3))) (if (is-eq (var-get var-even-c) (var-get var-odd-c)) 126 74) (if (and (not (or (is-done u4) (is-done u5))) (or (is-done u2) (is-done u3))) 20 (if (and (or (is-done u4) (is-done u5)) (not (or (is-done u2) (is-done u3)))) 180 100)))))
        (map-set claims (unwrap-panic (var-get role-odd)) (to-uint (if (and (or (is-done u4) (is-done u5)) (or (is-done u2) (is-done u3))) (if (is-eq (var-get var-even-c) (var-get var-odd-c)) 74 126) (if (and (not (or (is-done u4) (is-done u5))) (or (is-done u2) (is-done u3))) 180 (if (and (or (is-done u4) (is-done u5)) (not (or (is-done u2) (is-done u3)))) 20 100)))))
...
(define-public (timeout)
    (begin
        ...
        (if (not (is-done u0)) (begin (map-set claims (unwrap-panic (var-get role-even)) u100) (map-set claims (unwrap-panic (var-get role-odd)) u100) (var-set payoffs-distributed true) (ok true)) (err ERR_NOT_OPEN))
    )
)

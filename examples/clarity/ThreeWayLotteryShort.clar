;; ThreeWayLotteryShort - Generated by Vegas Clarity Backend
...
;; Actions
(define-public (action-issuer-1 (c (buff 32)) )
...
(define-public (action-issuer-2 (c int) (c-salt (buff 32)) )
    (let ((st (var-get state)))
        (asserts! (var-get initialized) ERR_NOT_INITIALIZED)
        (asserts! (is-eq (some tx-sender) (var-get role-issuer)) ERR_WRONG_ROLE)
...
(define-public (action-alice-3 (c (buff 32)) )
    (let ((st (var-get state)))
        (asserts! (var-get initialized) ERR_NOT_INITIALIZED)
...
(define-public (action-alice-4 (c int) (c-salt (buff 32)) )
    (let ((st (var-get state)))
        (asserts! (var-get initialized) ERR_NOT_INITIALIZED)
        (asserts! (is-eq (some tx-sender) (var-get role-alice)) ERR_WRONG_ROLE)
...
(define-public (action-bob-5 (c (buff 32)) )
    (let ((st (var-get state)))
        (asserts! (var-get initialized) ERR_NOT_INITIALIZED)
...
(define-public (action-bob-6 (c int) (c-salt (buff 32)) )
    (let ((st (var-get state)))
        (asserts! (var-get initialized) ERR_NOT_INITIALIZED)
        (asserts! (is-eq (some tx-sender) (var-get role-bob)) ERR_WRONG_ROLE)

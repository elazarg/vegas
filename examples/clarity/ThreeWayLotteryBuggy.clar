...
(define-public (finalize)
    (begin
        ...
        (map-set claims (unwrap-panic (var-get role-bob)) (if (and (and (or (is-done u5) (is-done u6)) (or (is-done u7) (is-done u8))) (or (is-done u3) (is-done u4))) (if (is-eq (var-get var-alice-c) (var-get var-bob-c)) 6 (if (is-eq (mod (+ (+ (var-get var-alice-c) (var-get var-bob-c)) (var-get var-issuer-c)) 2) 0) 6 24)) (if (and (not (or (is-done u5) (is-done u6))) (not (or (is-done u7) (is-done u8)))) 1 (if (and (not (or (is-done u5) (is-done u6))) (not (or (is-done u3) (is-done u4)))) 34 (if (and (not (or (is-done u7) (is-done u8))) (not (or (is-done u3) (is-done u4)))) 1 (if (not (or (is-done u5) (is-done u6))) 17 (if (not (or (is-done u7) (is-done u8))) 2 (if (not (or (is-done u3) (is-done u4))) 17 12))))))))
        (map-set claims (unwrap-panic (var-get role-issuer)) (if (and (and (or (is-done u5) (is-done u6)) (or (is-done u7) (is-done u8))) (or (is-done u3) (is-done u4))) (if (is-eq (var-get var-alice-c) (var-get var-bob-c)) 24 (if (is-eq (mod (+ (+ (var-get var-alice-c) (var-get var-bob-c)) (var-get var-issuer-c)) 2) 0) 6 6)) (if (and (not (or (is-done u5) (is-done u6))) (not (or (is-done u7) (is-done u8)))) 34 (if (and (not (or (is-done u5) (is-done u6))) (not (or (is-done u3) (is-done u4)))) 1 (if (and (not (or (is-done u7) (is-done u8))) (not (or (is-done u3) (is-done u4)))) 1 (if (not (or (is-done u5) (is-done u6))) 17 (if (not (or (is-done u7) (is-done u8))) 17 (if (not (or (is-done u3) (is-done u4))) 2 12))))))))
        (map-set claims (unwrap-panic (var-get role-alice)) (if (and (and (or (is-done u5) (is-done u6)) (or (is-done u7) (is-done u8))) (or (is-done u3) (is-done u4))) (if (is-eq (var-get var-alice-c) (var-get var-bob-c)) 6 (if (is-eq (mod (+ (+ (var-get var-alice-c) (var-get var-bob-c)) (var-get var-issuer-c)) 2) 0) 24 6)) (if (and (not (or (is-done u5) (is-done u6))) (not (or (is-done u7) (is-done u8)))) 1 (if (and (not (or (is-done u5) (is-done u6))) (not (or (is-done u3) (is-done u4)))) 1 (if (and (not (or (is-done u7) (is-done u8))) (not (or (is-done u3) (is-done u4)))) 34 (if (not (or (is-done u5) (is-done u6))) 2 (if (not (or (is-done u7) (is-done u8))) 17 (if (not (or (is-done u3) (is-done u4))) 17 12))))))))

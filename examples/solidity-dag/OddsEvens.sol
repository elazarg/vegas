...
contract OddsEvens {
    ...
    function move_Odd_0() public payable by(Role.None) notDone(1) {
    ...
    function move_Odd_1(uint256 _hidden_c) public by(Role.Odd) notDone(3) {
    ...
    function move_Even_1(uint256 _hidden_c) public by(Role.Even) notDone(2) {

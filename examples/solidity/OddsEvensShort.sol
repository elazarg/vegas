...
contract OddsEvensShort {
    ...
    function move_Odd_0(bytes32 _hidden_c) public payable by(Role.Odd) action(Role.Odd, 1) {
    ...
    function move_Even_2(bytes32 _hidden_c) public payable by(Role.Even) action(Role.Even, 3) {

...
pub mod tictactoe {
    ...
    pub fn move_O_7(ctx: Context<Move_O_7>, c3: i64) -> Result<()> {
         ...
         if !(game.bailed[0 as usize]) {
             require!((game.action_done[6 as usize] || game.bailed[1 as usize]), ErrorCode::DependencyNotMet);
         }
         if !(game.bailed[0 as usize]) {
             require!((game.action_done[2 as usize] || game.bailed[1 as usize]), ErrorCode::DependencyNotMet);
         }
    ...
    pub fn move_X_8(ctx: Context<Move_X_8>, c4: i64) -> Result<()> {
         ...
         if !(game.bailed[1 as usize]) {
             require!((game.action_done[7 as usize] || game.bailed[0 as usize]), ErrorCode::DependencyNotMet);
         }
         if !(game.bailed[1 as usize]) {
             require!((game.action_done[2 as usize] || game.bailed[1 as usize]), ErrorCode::DependencyNotMet);
         }
    ...
    pub fn move_O_9(ctx: Context<Move_O_9>, c4: i64) -> Result<()> {
         ...
         if !(game.bailed[0 as usize]) {
             require!((game.action_done[8 as usize] || game.bailed[1 as usize]), ErrorCode::DependencyNotMet);
         }
         if !(game.bailed[0 as usize]) {
             require!((game.action_done[2 as usize] || game.bailed[1 as usize]), ErrorCode::DependencyNotMet);
         }

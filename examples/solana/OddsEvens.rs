...
pub mod oddsevens {
    ...
    pub fn timeout_Odd_1(ctx: Context<Timeout_Odd_1>, ) -> Result<()> {
        let game = &mut ctx.accounts.game;
    ...
    pub fn timeout_Even_0(ctx: Context<Timeout_Even_0>, ) -> Result<()> {
        let game = &mut ctx.accounts.game;
        let _signer = &mut ctx.accounts._signer;
         require!(!(game.is_finalized), ErrorCode::GameFinalized);
    ...
    pub fn timeout_Odd_2(ctx: Context<Timeout_Odd_2>, ) -> Result<()> {
        let game = &mut ctx.accounts.game;
        let _signer = &mut ctx.accounts._signer;
         require!(!(game.is_finalized), ErrorCode::GameFinalized);
         require!(!(game.bailed[1 as usize]), ErrorCode::AlreadyDone);
    ...
    pub fn timeout_Even_4(ctx: Context<Timeout_Even_4>, ) -> Result<()> {
        let game = &mut ctx.accounts.game;
        let _signer = &mut ctx.accounts._signer;
         require!(!(game.is_finalized), ErrorCode::GameFinalized);
         require!(!(game.bailed[0 as usize]), ErrorCode::AlreadyDone);
    ...
    pub fn timeout_Odd_3(ctx: Context<Timeout_Odd_3>, ) -> Result<()> {
        let game = &mut ctx.accounts.game;
        let _signer = &mut ctx.accounts._signer;
         require!(!(game.is_finalized), ErrorCode::GameFinalized);
         require!(!(game.bailed[1 as usize]), ErrorCode::AlreadyDone);
    ...
    pub fn timeout_Even_5(ctx: Context<Timeout_Even_5>, ) -> Result<()> {
        let game = &mut ctx.accounts.game;
        let _signer = &mut ctx.accounts._signer;
         require!(!(game.is_finalized), ErrorCode::GameFinalized);
         require!(!(game.bailed[0 as usize]), ErrorCode::AlreadyDone);
    ...
    lamports.saturating_sub(rent)
         ...
         if (((0 + p_Even) + p_Odd) > spendable_pot) {
...
#[derive(Accounts)]
pub struct Timeout_Even_0<'info> {
    #[account(mut)]
    #[account(seeds = [b"game", game.game_id.to_le_bytes().as_ref()], bump)]
    pub game: Account<'info, GameState>,
    #[account(mut)]
...
#[derive(Accounts)]
pub struct Timeout_Even_4<'info> {
    #[account(mut)]
    #[account(seeds = [b"game", game.game_id.to_le_bytes().as_ref()], bump)]
    pub game: Account<'info, GameState>,
    #[account(mut)]
...
#[derive(Accounts)]
pub struct Timeout_Even_5<'info> {
    #[account(mut)]
    #[account(seeds = [b"game", game.game_id.to_le_bytes().as_ref()], bump)]
    pub game: Account<'info, GameState>,
    #[account(mut)]
